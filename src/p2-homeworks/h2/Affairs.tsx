...
function Affairs(props: AffairsPropsType) {
    ...
    /*  const cnAll = s.button + " " + (props.setFilter === "all" ? s.active : "")
      const cnHigh = s.button + " " + (props.setFilter === "high" ? s.active : "")
      const cnMiddle = s.button + " " + (props.setFilter === "middle" ? s.active : "")
      const cnLow = s.button + " " + (props.setFilter === "low" ? s.active : "")*/
